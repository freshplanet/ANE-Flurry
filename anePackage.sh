...
echo "creating jar: " ant 
cd ${android_native_directory}
ant
cd ${root_directory}
cp ${android_native_directory}${android_build_name} ${android_build_directory}/
